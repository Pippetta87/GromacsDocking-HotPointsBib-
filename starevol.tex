...
\chapter{Steady state: mechanical and thermal, spherical symmetry}%
\PartialToc%
...
\begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
  ...
  \node[entity] (structure) at (0,0) {Structure stellar eqs};
\draw[link,<-]  (structure.180)--++(0:2cm) node[attribute,anchor=120+180] (hyp) {Equilibrio idrostatico, Equilibrio termico locale, Equilibrio radiativo + criterio di Schwartzchild};
